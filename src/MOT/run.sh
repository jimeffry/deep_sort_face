...
#**************************head track
python demo_deepsort.py /data/videos/test2.mp4 --headmodelpath /data/models/head/sfd_crowedhuman_280000.pth  --feature_model /data/models/deep_sort/ckpt.t7 --face_load_num 0   --tracker_type staple --mot_type head
#******************kalman
