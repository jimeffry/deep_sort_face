...
def draw_bbox(img, box, cls_name, identity=None, offset=(0,0)):
    ...
    # box text and bar
    t_size = cv2.getTextSize(label, cv2.FONT_HERSHEY_SIMPLEX, 1 , 1)[0] # FONT_HERSHEY_PLAIN
    cv2.rectangle(img,(x1, y1),(x2,y2),color,8)
    #cv2.rectangle(img,(x1, y1),(x1+t_size[0]+3,y1+t_size[1]+4), color,-1)
    cv2.putText(img,label,(x1,y1+t_size[1]+4), cv2.FONT_HERSHEY_SIMPLEX, 1, [255,255,255], 1)
    return img
